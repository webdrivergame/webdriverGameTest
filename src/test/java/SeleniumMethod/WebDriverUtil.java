 ...
 */
   ...
   */
        ...
        public void cssClick(String cssClick) {

            driver.findElement(By.xpath(cssClick)).click();
        }
...
public WebElement waitForElement(String xpath, int timeout ) {
  ...
  */
        ...
        /**
         *     切换到指定title的窗口,并关闭当前窗口
         */
        public void switchToWindowTitleClose(String windowTitle) {
            Set<String> windowHandles = driver.getWindowHandles();//获取所有窗口句柄
            //System.out.println(windowHandles.size());  //输出句柄集合
            for (String handler : windowHandles) {
                //driver.switchTo().window(handler);
